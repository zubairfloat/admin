  ...
  return (
    <div className={`card card-custom bg-gray-100 ${className}`}>
      ...
      <div className="card-header border-0 bg-danger py-5">
        <h3 className="card-title font-weight-bolder text-white">Couriers Stat</h3>
      </div>
      {/* Body */}
      <div className="card-body p-0 position-relative overflow-hidden">
        ...
        <div className="card-spacer mt-n25">
          <div className="row m-0">
            <div onClick={displayShipemt} style={{ cursor: "pointer" }} className="col bg-light-warning px-6 py-8 rounded-xl mr-7 mb-7 " >
            ...
            <div onClick={displayUser} style={{ cursor: "pointer" }} className="col bg-light-primary px-6 py-8 rounded-xl mb-7">
